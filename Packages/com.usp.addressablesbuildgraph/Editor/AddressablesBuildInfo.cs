...
{
    public class AddressablesBuildInfo : ISerializationCallbackReceiver
    {
        ...
        #region Properties
        /// <summary>
        /// A unique set of all Addressbles groups used to generate the build.
        /// </summary>
        [SerializeReference]
        private GroupInfo[] groups;

        /// <summary>
        /// A unique set of all assets used to generate the build.
        /// </summary>
        [SerializeReference]
        private AssetInfo[] assets;

        /// <summary>
        /// A unique set of all bundles generated by the build.
        /// </summary>
        [SerializeReference]
        ...
        /// </summary>
        public HashSet<GroupInfo> Groups { get; private set; }
        ...
        #region Methods
        public AddressablesBuildInfo()
        {
            Groups = new HashSet<GroupInfo>();
            Assets = new HashSet<AssetInfo>();
            AssetBundles = new HashSet<AssetBundleInfo>();
    }
        ...
        {
            groups = new GroupInfo[Groups.Count];
            Groups.CopyTo(groups);
        ...
        {
            Groups = new HashSet<GroupInfo>(groups);
